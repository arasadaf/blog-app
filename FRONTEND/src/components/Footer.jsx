        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-gray-600">
              ...
              <li><NavLink to="/userdashboard" className="hover:text-indigo-600 transition">Articles</NavLink></li>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-6">Stay Inspired</h3>
